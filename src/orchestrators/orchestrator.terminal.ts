...
const NETWORK_CONFIG = {
  PLAN_INTERVAL: 100,
  ENERGY_RICH_THRESHOLD: 200_000,
  ENERGY_POOR_THRESHOLD: 50_000,
...
const MARKET_MAKER_CONFIG = {
  ...
  MIN_SELL_SURPLUS: 5_000,
  ORDER_LOT: 5_000,
  TOPUP_THRESHOLD: 1_000,
  UNDERCUT: 0.001,
  MIN_CREDITS_TO_POST: 10_000,
...
const ENERGY_TRADE_CONFIG = {
  INTERVAL: 100,
  SELL_STORAGE_THRESHOLD: 400_000,
  SELL_KEEP: 350_000,
  SELL_MIN_PRICE: 2,
  SELL_MAX_AMOUNT: 5_000,
  BUY_STORAGE_THRESHOLD: 30_000,
  BUY_MAX_PRICE: 1,
  BUY_MAX_AMOUNT: 5_000,
  MIN_CREDITS_TO_BUY: 50_000,
};
