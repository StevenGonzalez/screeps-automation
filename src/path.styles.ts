...
export const PATH_STYLES: Record<PathIntent, PolyStyle> = {
  move: { stroke: "#bbbbbb", opacity: 0.5, strokeWidth: 0.15 },
  harvest: { stroke: "#ffaa00", opacity: 0.8, strokeWidth: 0.15 }, // amber
  withdraw: { stroke: "#0a84ff", opacity: 0.9, strokeWidth: 0.15 }, // blue
  transfer: { stroke: "#00d26a", opacity: 0.9, strokeWidth: 0.18 }, // green
  build: { stroke: "#ffffff", opacity: 0.9, strokeWidth: 0.15 }, // white
  repair: { stroke: "#00ffff", opacity: 0.9, strokeWidth: 0.15 }, // cyan
  upgrade: { stroke: "#ff00ff", opacity: 0.9, strokeWidth: 0.15 }, // magenta
  attack: { stroke: "#ff3b30", opacity: 0.9, strokeWidth: 0.2 }, // red
  heal: { stroke: "#34c759", opacity: 0.9, strokeWidth: 0.18 }, // lime green
  flee: { stroke: "#ff0000", opacity: 1.0, strokeWidth: 0.12 }, // thin urgent red
};
