  ...
  if (creep.memory.working) {
    ...
    if (link) {
      ...
      if (w === ERR_NOT_IN_RANGE) {
        creep.moveTo(link, { ...visualPath("withdraw") });
        CreepPersonality.speak(creep, "move");
      } else if (w === OK) {
    ...
    if (
      ...
      if (w === ERR_NOT_IN_RANGE) {
        creep.moveTo(ctrlContainer, { ...visualPath("withdraw") });
        CreepPersonality.speak(creep, "move");
      } else if (w === OK) {
        CreepPersonality.speak(creep, "withdraw");
      }
    ...
    if (
      ...
      if (w === ERR_NOT_IN_RANGE) {
        creep.moveTo(storage, { ...visualPath("withdraw") });
        CreepPersonality.speak(creep, "move");
      } else if (w === OK) {
        CreepPersonality.speak(creep, "withdraw");
      }
    ...
    if (containers.length) {
      ...
      if (tgt) {
        ...
        if (w === ERR_NOT_IN_RANGE) {
          creep.moveTo(tgt, { ...visualPath("withdraw") });
          CreepPersonality.speak(creep, "move");
        } else if (w === OK) {
          CreepPersonality.speak(creep, "withdraw");
        }
    ...
    if (ctrl) {
      ...
      if (dropped) {
        ...
        if (p === ERR_NOT_IN_RANGE) {
          creep.moveTo(dropped, { ...visualPath("withdraw") });
          CreepPersonality.speak(creep, "move");
        } else if (p === OK) {
          CreepPersonality.speak(creep, "withdraw");
        }
